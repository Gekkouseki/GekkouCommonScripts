...
public class NegaTimer
{
    ...
    /// 設定時間が終了したかどうか
    /// </summary>
    public bool IsTimeUp { get => 0.0f >= _elaspedTime; }

    /// <summary>
    /// 経過時間/設定時間の割合 1->0
    /// </summary>
    public float TimeRate { get => IsTimeUp ? 0.0f : _elaspedTime / _intervalTime; }
    ...
    /// 残り時間
    /// </summary>
    public float LeftTime { get => _elaspedTime; }

    /// <summary>
    /// 経過時間
    /// </summary>
    public float ElaspedTime { get => _intervalTime - _elaspedTime; }
    #endregion
    ...
    public NegaTimer(float interval = 0.0f)
    {
    ...
    /// <param name="scale">経過速度(1.0fで通常速度)</param>
    /// <returns>経過時間を超えたかどうか</returns>
    public bool LoopTimer(float scale = 1.0f)
    {
